      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 w-full">
        <div className="space-y-6">
          <h1 className="text-7xl font-bold">
            Hi, I'm <span className="text-blue-600">Praneeth</span><br/>Sai Chunchu.
          </h1>
          ...
          <p className="text-xl font-bold">
            Software Engineer(Machine Learning, NLP, MLOps)
          </p>
        ...
        <div className="relative flex justify-center items-center">
          {show3D ? (
            ...
            <div className="w-96 h-96 relative">
              ...
              {/* Toggle to Photo Button */}
              <button
                onClick={() => setShow3D(false)}
                className="absolute bottom-4 right-4 bg-blue-600 text-white px-4 py-2 rounded-full text-sm hover:bg-blue-700 transition shadow-lg flex items-center gap-2 z-10"
              >
            ...
            <div className="relative">
              <img 
                ...
                className="w-96 h-96 object-cover border-8 border-white dark:border-gray-800 rounded-2xl shadow-2xl"
              />
              
              {/* Toggle to 3D Button */}
              <button
                onClick={() => setShow3D(true)}
                className="absolute bottom-4 right-4 bg-blue-600 text-white px-4 py-2 rounded-full text-sm hover:bg-blue-700 transition shadow-lg flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
